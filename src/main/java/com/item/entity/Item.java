 ...
 * 
 * This class is mapped to the "items" table in the database and includes
...
public class Item {
	...
	@Min(value = 1, message = "Item quantity should be at least 1 or greater than 1")
	...
	@Min(value = 1, message = "Item Dimension should be at least 1 or greater than 1")
